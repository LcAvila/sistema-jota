...
exports.getDashboardData = exports.getSalesReports = exports.deleteSale = exports.updateSale = exports.getSaleById = exports.getAllSales = exports.createSale = void 0;
...
const getAllSales = async (req, res) => {
    try {
        const { page = '1', limit = '10', startDate, endDate, sellerId, clientId, status = 'Concluído' } = req.query;
    ...
    try {
        ...
        const topProductsWithDetails = topProducts.map(item => {
            ...
            return {
                ...
                revenue: (item._sum.qty || 0) * (product?.price ? new client_1.Prisma.Decimal(product.price).toNumber() : 0)
            };
        });
        // Vendedores top
