...
exports.getDashboardMetrics = exports.getDashboardFilterOptions = void 0;
const client_1 = require("@prisma/client");
const prisma = new client_1.PrismaClient();
const getDashboardFilterOptions = async (req, res) => {
    try {
...
exports.getDashboardFilterOptions = getDashboardFilterOptions;
const getDashboardMetrics = async (req, res) => {
    ...
    const paymentWhere = {};
    if (paymentMethod) {
        paymentWhere.paymentMethod = { name: paymentMethod };
        where.orderPayments = {
            some: paymentWhere,
        };
    }
